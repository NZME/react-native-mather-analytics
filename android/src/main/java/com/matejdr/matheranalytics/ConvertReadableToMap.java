...
public class ConvertReadableToMap {
    ...
    public static List<Object> getArray(ReadableArray readableArray) {
    ...
    public static List<String> getArrayOfStrings(ReadableArray readableArray) {
        List<String> parsedList = new ArrayList<String>(readableArray.size());
        for (int i = 0; i < readableArray.size(); i++) {
            ReadableType type = readableArray.getType(i);
            switch(type) {
                case String:
